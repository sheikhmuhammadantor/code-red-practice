...
const SideDrawer = () => {
  ...
  const handelSearch = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(`${process.env.CHAT_EXPRESS_SERVER}/api/user?search=${search}`, config);
    ...
    const accessChat = async (userId) => {
      ...
      try {
        ...
        const { data } = await axios.post(`${process.env.CHAT_EXPRESS_SERVER}/api/chat`, { userId }, config);
